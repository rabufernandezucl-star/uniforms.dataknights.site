...
$keys = [
    'college_karate_arnis_xs',
    'college_karate_arnis_s',
    'college_karate_arnis_m',
    'college_karate_arnis_l',
    'college_karate_arnis_xl',
    'college_karate_arnis_xxl'
];
...
$key = 'college_karate_arnis_' . strtolower($size);
