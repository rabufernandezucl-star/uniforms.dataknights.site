...
$keys = [
    'pe_uniform_tshirt_xs',
    'pe_uniform_tshirt_s',
    'pe_uniform_tshirt_m',
    'pe_uniform_tshirt_l',
    'pe_uniform_tshirt_xl',
    'pe_uniform_tshirt_xxl',
    'pe_uniform_tshirt_xxxl',
    'pe_uniform_tshirt_xxxxl',
    'pe_uniform_tshirt_xxxxxl'
];
...
$key = 'pe_uniform_tshirt_' . strtolower($size);
